...
for (index in datasets){
    ...
    // we only insert this graph on the page if we can find where to insert it
    if( d3.select(graph_id).empty() ){
        // no id on this page to insert into
        continue;
    }
